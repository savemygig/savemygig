...
export function initAccounts(core: ChecklistCore, me?: any): AccountLayer {
  ...
  function renderPills() {
    ...
    reg.lists.forEach((l) => {
      ...
      core.attachExplainer(pill, () => 'Tap to switch to this list. Ticks, notes and any edits are saved to each list separately.');
